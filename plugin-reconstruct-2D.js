var jsPsychReconstruct_2D = (function (jspsych) {    
  ...
  class Reconstruction2DPlugin {
    ...
    //   }   
      ...
      find_coord (mouse_position, reference_point, cell_size){        
        var rp = Math.floor((mouse_position - reference_point)/cell_size)
        return rp
      }
      find_param (mouse_x, mouse_y) {
          ...
          // find coordinates
          var x_coord = this.find_coord(mouse_x, rect.left, hori_cell_size);
          var y_coord = this.find_coord(mouse_y, rect.top, vert_cell_size);
          var coord_idx = this.cell_coordinates.indexOf(x_coord+'_'+y_coord);
